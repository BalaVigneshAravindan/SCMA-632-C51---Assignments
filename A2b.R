...
match_details <- read.csv("C:\\Users\\Bala Vignesh.A\\Downloads\\IPL_ball_by_ball_updated till 2024.csv", stringsAsFactors = FALSE)

# Load player salary data
player_salary <- read_excel("C:\\Users\\Bala Vignesh.A\\Downloads\\IPL SALARIES 2024.xlsx")
